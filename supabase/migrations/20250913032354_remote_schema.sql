...
revoke delete on table "public"."cell_reports" from "anon";

revoke insert on table "public"."cell_reports" from "anon";

revoke references on table "public"."cell_reports" from "anon";

revoke select on table "public"."cell_reports" from "anon";

revoke trigger on table "public"."cell_reports" from "anon";

revoke truncate on table "public"."cell_reports" from "anon";

revoke update on table "public"."cell_reports" from "anon";

revoke delete on table "public"."cell_reports" from "authenticated";

revoke insert on table "public"."cell_reports" from "authenticated";

revoke references on table "public"."cell_reports" from "authenticated";

revoke select on table "public"."cell_reports" from "authenticated";

revoke trigger on table "public"."cell_reports" from "authenticated";

revoke truncate on table "public"."cell_reports" from "authenticated";

revoke update on table "public"."cell_reports" from "authenticated";

revoke delete on table "public"."cell_reports" from "service_role";

revoke insert on table "public"."cell_reports" from "service_role";

revoke references on table "public"."cell_reports" from "service_role";

revoke select on table "public"."cell_reports" from "service_role";

revoke trigger on table "public"."cell_reports" from "service_role";

revoke truncate on table "public"."cell_reports" from "service_role";

revoke update on table "public"."cell_reports" from "service_role";

revoke delete on table "public"."course_registrations" from "anon";

revoke insert on table "public"."course_registrations" from "anon";

revoke references on table "public"."course_registrations" from "anon";

revoke select on table "public"."course_registrations" from "anon";

revoke trigger on table "public"."course_registrations" from "anon";

revoke truncate on table "public"."course_registrations" from "anon";

revoke update on table "public"."course_registrations" from "anon";

revoke delete on table "public"."course_registrations" from "authenticated";

revoke insert on table "public"."course_registrations" from "authenticated";

revoke references on table "public"."course_registrations" from "authenticated";

revoke select on table "public"."course_registrations" from "authenticated";

revoke trigger on table "public"."course_registrations" from "authenticated";

revoke truncate on table "public"."course_registrations" from "authenticated";

revoke update on table "public"."course_registrations" from "authenticated";

revoke delete on table "public"."course_registrations" from "service_role";

revoke insert on table "public"."course_registrations" from "service_role";

revoke references on table "public"."course_registrations" from "service_role";

revoke select on table "public"."course_registrations" from "service_role";

revoke trigger on table "public"."course_registrations" from "service_role";

revoke truncate on table "public"."course_registrations" from "service_role";

revoke update on table "public"."course_registrations" from "service_role";
