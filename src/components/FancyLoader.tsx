  ...
  return (
    <div className="fixed inset-0 z-[60] grid place-items-center bg-gradient-to-br from-background via-background to-primary/10 px-4">
      <div className="relative w-full max-w-sm px-6 py-8 rounded-2xl border bg-background/85 backdrop-blur shadow-[0_0_40px_-10px_theme(colors.primary/50%)]">
        {/*
          Animações removidas a pedido do usuário (deixadas comentadas para
          reativar facilmente no futuro, se desejado).

          Versão original com anéis girando + logo saltitando:
        ...
        */}
        ...
        <div className="pt-10 text-center space-y-2">
          ...
          {tip && (
            // animate-pulse removido a pedido do usuário
        ...
        {/*
          Barra de progresso com shimmer animado — removida a pedido do
          usuário. Original:
